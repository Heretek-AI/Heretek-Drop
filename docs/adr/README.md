...
| [0004](0004-accept-slint-transitive-unmaintained-deps.md) | Accepted | Accept Slint transitive unmaintained-deps warnings | Formalizes ignore for 4 transitive unmaintained crates from Slint 1.17 (paste, bincode, rustybuzz, ttf-parser) |
